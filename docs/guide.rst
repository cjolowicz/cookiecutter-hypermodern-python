...
.. _2020.7.15: https://github.com/cjolowicz/cookiecutter-hypermodern-python/releases/tag/2020.7.15
...
Use the ``--checkout`` option with the `current stable release <2020.7.15_>`__:
