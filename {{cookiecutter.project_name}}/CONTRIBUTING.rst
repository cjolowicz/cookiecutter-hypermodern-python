...
This project is open-source under the `{{cookiecutter.full_license_name}}`_ and
...
.. _{{cookiecutter.full_license_name}}: https://opensource.org/licenses/{{cookiecutter.license}}
